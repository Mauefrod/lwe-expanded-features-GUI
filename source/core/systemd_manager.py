"""Systemd startup manager for the application"""
import subprocess
...
# Some of these functions are mostly wrappers or should be labelled as "_private_functions()" but I coded this at 4
# am and I don't feel like refactoring.
...
def enable_startup():
    ...
    except subprocess.CalledProcessError as e: # Known systemd exceptions, easier feedback
        return False, f"Failed to enable startup: {e.stderr.decode()}"
    except Exception as e: # If you get an exception here, use holy water, sacrifice a goat and wipe the codebase
